...
Welcome to my GitHub profile! I'm Abhijit Pradhan, a passionate developer with interests in Web Development, Android Development, and Data Structures & Algorithms (DSA). Here you'll find a mix of personal projects, contributions, and the occasional random idea.

## 🔧 Technologies & Tools
### 💻 Programming Languages
`C`, `C++`, `Java`, `Python`, `JavaScript` 💛, `PHP`, `Go`, `Kotlin`, `Dart`
---
### 🌐 Web Frameworks & Libraries
- `React`, `Next.js`, `Django`  
- `Tailwind CSS`, `Shadcn/UI`, `GSAP`, `Framer Motion`  
...
- `Node.js`, `Bun`, `Express`, `Hono`  
- `Flask`, `FastAPI`
---
### 🛢️ Databases & ORMs
- SQL: `MySQL`, `PostgreSQL`, `D1 (Cloudflare)`  
- NoSQL: `MongoDB`  
- ORMs: `Drizzle`, `Prisma`, `Mongoose`
---
### 🧰 Dev Tools & IDEs
- Editors: `VS Code`, `PyCharm`, `IntelliJ IDEA`, `Android Studio`  
- API Tools: `Postman`
---
### 🐳 DevOps & Infrastructure
- `Docker`, `Linux`  
- Cloud: `Cloudflare`, `AWS EC2`, `ECS`, `S3`, `R2`
---
### ☁️ Backend-as-a-Service (BaaS)
- `Supabase`, `Appwrite`, `Convex`, `Firebase` 
